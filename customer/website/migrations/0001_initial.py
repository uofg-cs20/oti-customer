# Generated by Django 3.0.3 on 2021-01-23 20:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.MonetaryValue')),
                ('usage_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='website.Usage')),
            ],
        ),
        migrations.AddField(
            model_name='purchase',
