# Generated by Django 3.0.3 on 2020-11-17 17:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='website.Concession')),
            ],
        ),
        migrations.CreateModel(
            name='UsageFromTo',
        ...
        migrations.AddField(
            model_name='purchase',
            name='location_from',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='requests_created', to='website.Location'),
        ),
        migrations.AddField(
            model_name='purchase',
            name='location_to',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='website.Location'),
        ),
        migrations.AddField(
            model_name='purchase',
            name='mode',
