...
def populate():
    ...
    price7, created = MonetaryValue.objects.get_or_create(amount="7.00", currency="GBP")
    ...
    location_from2, created = Location.objects.get_or_create(lat_long=coordinates_from2, NaPTAN="idk", other="Glasgow")
    ...
    location_to2, created = Location.objects.get_or_create(lat_long=coordinates_to2, NaPTAN="idk", other="Stirling")
    ...
    price8, created = MonetaryValue.objects.get_or_create(amount="12.00", currency="GBP")
    transaction8, created = Transaction.objects.get_or_create(payment_type="Visa", payment_method="Debit", price=price8)
    account_balance8, created = MonetaryValue.objects.get_or_create(amount="100.00", currency="GBP")
    ...
    location_from8, created = Location.objects.get_or_create(lat_long=coordinates_from8, NaPTAN="idk", other="Edinburgh")
    ...
    location_to8, created = Location.objects.get_or_create(lat_long=coordinates_to8, NaPTAN="idk", other="Dundee")
    ...
    price9, created = MonetaryValue.objects.get_or_create(amount="11.00", currency="GBP")
    transaction9, created = Transaction.objects.get_or_create(payment_type="Visa", payment_method="Debit", price=price9)
    account_balance9, created = MonetaryValue.objects.get_or_create(amount="100.00", currency="GBP")
    ...
    location_from9, created = Location.objects.get_or_create(lat_long=coordinates_from9, NaPTAN="idk")
    ...
    location_to9, created = Location.objects.get_or_create(lat_long=coordinates_to9, NaPTAN="idk", other="St Andrews")
    ...
    location_to3, created = Location.objects.get_or_create(lat_long=coordinates_to3, NaPTAN="idk", other="Glasgow Queen Street")
    ...
    location_from3, created = Location.objects.get_or_create(lat_long=coordinates_from3, NaPTAN="idk", other="Stirling")
    ...
    location_to10, created = Location.objects.get_or_create(lat_long=coordinates_to10, NaPTAN="idk", other="Edinburgh Haymarket")
    ...
    location_from10, created = Location.objects.get_or_create(lat_long=coordinates_from10, NaPTAN="idk", other="Dundee")
