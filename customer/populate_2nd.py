...
def populate():  
    ...
    discount1, created = Discount.objects.get_or_create(discount_type="Young person", discount_value="0.25", discount_description="16-25 Railcard")
    ...
    discount7, created = Discount.objects.get_or_create(discount_type="Student", discount_value="0.15", discount_description="Student Railcard")
    ...
    discount6, created = Discount.objects.get_or_create(discount_type="Senior Traveller", discount_value="0.55", discount_description="Over 60 yrs")
